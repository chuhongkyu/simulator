...
const Nav = () => {
    const { cameraMode, setCameraMode } = useCameraControllerStore();

    const handleCameraMode = () => {
        setCameraMode(cameraMode === "Following" ? "Default" : "Following");
    }
    ...
    return (
        <nav className="absolute z-10 top-2 right-2 flex bg-white rounded-lg p-2">
            <ul className="flex flex-col gap-2">
                ...
                <li>
                    <button className="p-1 bg-white rounded-md hover:bg-gray-100 transition-colors duration-200 cursor-pointer flex items-center justify-center">
